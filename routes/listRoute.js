...
const { validate, listValidation, taskValidation, updateValidation } = require('../config/validation.js'); 
...
router.put('/list/task/:task', validate(updateValidation) ,listController.editTask);
